declare module '@kp-react-visual-design/iframe-resizer-react' {
  ...
  namespace IframeResizer {
    ...
    type IframeResizerProps = Omit<IframeProps, 'scrolling'> & ResizerOptions & ResizerEvents;
  }

  function IframeResizer(props: IframeResizer.IframeResizerProps): React.ReactElement;
