...
var SettingsPanel = function SettingsPanel() {
  ...
  var usePriceTypeReaction = function usePriceTypeReaction(field) {
    ...
    if (field.form.values.basicAttribute.relationStyle === 3) {
      ...
      field.dataSource = [].concat(_toConsumableArray(BASE_PRICE_TYPE_ENUMS), _toConsumableArray(REST_PRICE_TYPE_ENUMS));
    }
  };

  return /*#__PURE__*/React.createElement(Wrapper, null, /*#__PURE__*/React.createElement(SettingsGlobalStyled, null), /*#__PURE__*/React.createElement(Header, null, "\xB7", /*#__PURE__*/React.createElement("div", null, "\u914D\u7F6E\u5C5E\u6027"), /*#__PURE__*/React.createElement(Button, {
  ...
  })), !!schema ? /*#__PURE__*/React.createElement(Form, {
    form: formData
  }, /*#__PURE__*/React.createElement(FormLayoutStyled, {
    labelCol: 6,
    wrapperCol: 18
