...
var LinkCoupon = function LinkCoupon(_ref) {
  ...
  var _useState9 = useState(defaultValues),
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return setPayload(defaultValues);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 3;
              _context3.next = 6;
              return request.get("".concat(baseURL, "/marketing/template/list"), {
                headers: headers,
                params: {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(PickBtn, null, /*#__PURE__*/React.createElement("a", {
    onClick: handleClick
  }, (value === null || value === void 0 ? void 0 : value.templateName) || '请选择优惠券'), "\xA0", /*#__PURE__*/React.createElement(RightOutlined, null)), /*#__PURE__*/React.createElement(Modal, {
    title: "\u8DF3\u8F6C\u9875\u9762",
    open: visible,
    destroyOnClose: true,
    maskClosable: true,
