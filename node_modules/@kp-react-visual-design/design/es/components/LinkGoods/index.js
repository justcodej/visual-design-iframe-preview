...
var LinkGoods = function LinkGoods(_ref) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return request.post("".concat(baseURL, "/pindao/polymerize/link/queryMallCommodityLink"), {
                headers: headers,
                data: payload
              });
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(PickBtn, null, /*#__PURE__*/React.createElement("a", {
    onClick: handleClick
  }, (value === null || value === void 0 ? void 0 : value.commodityName) || '请选择商品'), "\xA0", /*#__PURE__*/React.createElement(RightOutlined, null)), /*#__PURE__*/React.createElement(Modal, {
    title: "\u8DF3\u8F6C\u9875\u9762",
    open: visible,
    destroyOnClose: true,
    width: 1000,
