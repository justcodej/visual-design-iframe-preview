...
var _BasisLayout = _interopRequireDefault(require("./BasisLayout"));

var _CompositePanel = _interopRequireDefault(require("./CompositePanel"));

var _SettingsPanel = _interopRequireDefault(require("./SettingsPanel"));

var _ComponentTreeWidget = _interopRequireDefault(require("./ComponentTreeWidget"));

var _ViewportPanel = _interopRequireDefault(require("./ViewportPanel"));

var _context6 = _interopRequireWildcard(require("./context"));

var _lodash = _interopRequireDefault(require("lodash"));

var _uuid = require("uuid");

var _global = require("../global.styled");
...
var VisualDesign = /*#__PURE__*/function (_React$Component) {
  ...
  function VisualDesign(props) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _utils.request.post(queryApi.query, {
                data: {},
                headers: headers
              });
            ...
            case 5:
              ...
              return _context.abrupt("return", _antd.message.error(msg));
    ...
    _this.createFormData = function () {
      ...
      var newFormData = (0, _core.createForm)({
        ...
        effects: function effects() {
          (0, _core.onFormInputChange)(function (form) {
            var list = _lodash.default.cloneDeep(selectedList);

            list[activeIndex].data = _lodash.default.cloneDeep(form.values);
            self.setState({
              selectedList: list
            });
          });
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 6:
                ...
                if (Array.isArray(_context3.t0)) {
                  _antd.message.error(_context3.t0[0].messages[0]);
                }
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                newSelectedList = _lodash.default.cloneDeep(selectedList);
                id = (0, _uuid.v4)();
                initialData = {
                  id: id,
                  name: widgetName,
                ...
                if (newSelectedList.length && widgetName === 'FooterNav') {
                  ...
                  _antd.message.info('「底部导航」已添加至底部');
                }
              ...
              case 12:
                ...
                if (Array.isArray(_context4.t0)) {
                  _antd.message.error(_context4.t0[0].messages[0]);
                }
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 6:
              ...
              return _context5.abrupt("return", _antd.message.error('必须包含「页面全局配置」'));
            ...
            case 11:
              ...
              if (Array.isArray(_context5.t0)) {
                _antd.message.error(_context5.t0[0].messages[0]);
              }
    ...
    _this.state = _objectSpread(_objectSpread({}, _context6.initialState), {}, {
      formData: (0, _core.createForm)()
    });
    return _this;
  }
  ...
  _createClass(VisualDesign, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/_react.default.createElement(_global.SettingsAnimationStyled, null), /*#__PURE__*/_react.default.createElement(_index.ModalStyled, _objectSpread(_objectSpread({
        width: "100vw"
      }, rest), {}, {
        destroyOnClose: true,
        footer: null,
      ...
      }, /*#__PURE__*/_react.default.createElement(_BasisLayout.default, {
        title: "VisualDesign",
        actions: /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
          style: {
            marginRight: 10
          },
          onClick: onCancel
        }, "\u5173\u95ED"), /*#__PURE__*/_react.default.createElement(_antd.Button, {
          onClick: this.handleSubmit,
          disabled: loading,
          loading: loading,
          icon: /*#__PURE__*/_react.default.createElement(_icons.CloudUploadOutlined, null),
          type: "primary"
        }, "\u4FDD\u5B58"))
      }, /*#__PURE__*/_react.default.createElement(_CompositePanel.default, null), /*#__PURE__*/_react.default.createElement(_ViewportPanel.default, null, /*#__PURE__*/_react.default.createElement(_ComponentTreeWidget.default, null)), /*#__PURE__*/_react.default.createElement(_reactTransitionGroup.CSSTransition, {
        in: !isPreviewing,
        timeout: 200,
        unmountOnExit: true,
        classNames: "settings-transition"
      }, /*#__PURE__*/_react.default.createElement(_SettingsPanel.default, null))))));
    }
  }]);
