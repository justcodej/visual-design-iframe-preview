(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('formily.react', ['exports', 'react-is'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.Formily = global.Formily || {}, global.Formily.React = {})));
    ...
    var getDependencyValue = function (field, pattern, property) {
        var _a = __read$2(String(pattern).split(/\s*#\s*/), 2), target = _a[0], path = _a[1];
    ...
    var getBaseScope = function (field, options) {
        ...
        return Formily.Shared.lazyMerge(options.scope, {
            $form: $form,
            $self: $self,
            ...
            return linkages.reduce(function (buf, item) {
                ...
                if (item.type === 'value:visible') {
                    ...
                    return buf.concat({
                        ...
                        when: transformCondition(item.condition),
                        fulfill: {
                            schema: SpecificationV1Polyfill(__assign$1({ version: '1.0' }, item.schema)),
                        },
                        otherwise: {
                            schema: SpecificationV1Polyfill(__assign$1({ version: '1.0' }, item.otherwise)),
                        },
                    });
                }
    ...
    var registerVoidComponents = function (components) {
        VOID_COMPONENTS.push.apply(VOID_COMPONENTS, __spreadArray$1([], __read$1(components), false));
    };
