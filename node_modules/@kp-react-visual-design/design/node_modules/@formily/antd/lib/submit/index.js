...
exports.Submit = (0, react_2.observer)(function (_a) {
    ...
    return (react_1.default.createElement(antd_1.Button, __assign({ htmlType: onSubmit ? 'button' : 'submit', type: "primary" }, props, { loading: props.loading !== undefined ? props.loading : form.submitting, onClick: function (e) {
            if (props.onClick) {
