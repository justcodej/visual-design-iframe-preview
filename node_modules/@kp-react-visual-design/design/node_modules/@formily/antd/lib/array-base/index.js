...
var ArrayBase = function (props) {
    ...
    return (react_1.default.createElement(react_2.RecordsScope, { getRecords: function () { return field.value; } },
        react_1.default.createElement(ArrayBaseContext.Provider, { value: { field: field, schema: schema, props: props } }, props.children)));
};
exports.ArrayBase = ArrayBase;
exports.ArrayBase.Item = function (_a) {
    var children = _a.children, props = __rest(_a, ["children"]);
    return (react_1.default.createElement(ItemContext.Provider, { value: props },
        react_1.default.createElement(react_2.RecordScope, { getIndex: function () { return props.index; }, getRecord: function () { return takeRecord(props.record); } }, children)));
};
...
exports.ArrayBase.Addition = function (props) {
    ...
    return (react_1.default.createElement(antd_1.Button, __assign({ type: "dashed", block: true }, props, { disabled: self === null || self === void 0 ? void 0 : self.disabled, className: (0, classnames_1.default)("".concat(prefixCls, "-addition"), props.className), onClick: function (e) {
        ...
        }, icon: react_1.default.createElement(icons_1.PlusOutlined, null) }), props.title || self.title));
};
exports.ArrayBase.Copy = react_1.default.forwardRef(function (props, ref) {
    ...
    if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
        return null;
    return (react_1.default.createElement(icons_1.CopyOutlined, __assign({}, props, { className: (0, classnames_1.default)("".concat(prefixCls, "-copy"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-copy-disabled") : '', props.className), ref: ref, onClick: function (e) {
...
exports.ArrayBase.Remove = react_1.default.forwardRef(function (props, ref) {
    ...
    if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
        return null;
    return (react_1.default.createElement(icons_1.DeleteOutlined, __assign({}, props, { className: (0, classnames_1.default)("".concat(prefixCls, "-remove"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-remove-disabled") : '', props.className), ref: ref, onClick: function (e) {
            var _a, _b, _c, _d;
            if (self === null || self === void 0 ? void 0 : self.disabled)
                return;
            e.stopPropagation();
...
exports.ArrayBase.MoveDown = react_1.default.forwardRef(function (props, ref) {
    ...
    if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
        return null;
    return (react_1.default.createElement(icons_1.DownOutlined, __assign({}, props, { className: (0, classnames_1.default)("".concat(prefixCls, "-move-down"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-move-down-disabled") : '', props.className), ref: ref, onClick: function (e) {
            var _a, _b, _c, _d;
            if (self === null || self === void 0 ? void 0 : self.disabled)
                return;
            e.stopPropagation();
...
exports.ArrayBase.MoveUp = react_1.default.forwardRef(function (props, ref) {
    ...
    if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
        return null;
    return (react_1.default.createElement(icons_1.UpOutlined, __assign({}, props, { className: (0, classnames_1.default)("".concat(prefixCls, "-move-up"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-move-up-disabled") : '', props.className), ref: ref, onClick: function (e) {
            var _a, _b, _c;
            if (self === null || self === void 0 ? void 0 : self.disabled)
                return;
            e.stopPropagation();
