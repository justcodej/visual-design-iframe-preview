...
function FormDialog(title, id, renderer) {
    ...
    var renderDialog = function (visible, resolve, reject) {
        ...
        return (react_1.default.createElement(react_2.Observer, null, function () { return (react_1.default.createElement(antd_1.Modal, __assign({}, modal, { visible: visible, confirmLoading: env.form.submitting, onCancel: function (e) {
                var _a;
