...
exports.Editable = (0, react_2.observer)(function (props) {
    ...
    var renderEditHelper = function () {
        if (editable)
            return;
        return (react_1.default.createElement(form_item_1.BaseItem, __assign({}, props, itemProps),
            pattern === 'editable' && (react_1.default.createElement(icons_1.EditOutlined, { className: "".concat(prefixCls, "-edit-btn") })),
            pattern !== 'editable' && (react_1.default.createElement(icons_1.MessageOutlined, { className: "".concat(prefixCls, "-edit-btn") }))));
    };
    var renderCloseHelper = function () {
        if (!editable)
            return;
        return (react_1.default.createElement(form_item_1.BaseItem, __assign({}, props),
            react_1.default.createElement(icons_1.CloseOutlined, { className: "".concat(prefixCls, "-close-btn") })));
    };
    ...
    return (react_1.default.createElement("div", { className: prefixCls, ref: innerRef, onClick: onClick },
        react_1.default.createElement("div", { className: "".concat(prefixCls, "-content") },
            react_1.default.createElement(form_item_1.BaseItem, __assign({}, props, itemProps), props.children),
            renderEditHelper(),
            renderCloseHelper())));
});
exports.Editable.Popover = (0, react_2.observer)(function (props) {
    ...
    return (react_1.default.createElement(antd_1.Popover, __assign({}, props, { title: props.title || field.title, visible: visible, className: (0, classnames_1.default)(prefixCls, props.className), content: props.children, trigger: "click", destroyTooltipOnHide: true, onVisibleChange: function (visible) {
            if (visible) {
                openPopover();
            }
            else {
        ...
        react_1.default.createElement("div", null,
            react_1.default.createElement(form_item_1.BaseItem, { className: "".concat(prefixCls, "-trigger") },
                react_1.default.createElement("div", { className: "".concat(prefixCls, "-content") },
                    react_1.default.createElement("span", { className: "".concat(prefixCls, "-preview") }, props.title || field.title),
                    pattern === 'editable' && (react_1.default.createElement(icons_1.EditOutlined, { className: "".concat(prefixCls, "-edit-btn") })),
                    pattern !== 'editable' && (react_1.default.createElement(icons_1.MessageOutlined, { className: "".concat(prefixCls, "-edit-btn") })))))));
});
