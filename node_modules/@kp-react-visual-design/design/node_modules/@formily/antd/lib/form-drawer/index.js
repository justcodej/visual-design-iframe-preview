...
function FormDrawer(title, id, renderer) {
    ...
    var renderDrawer = function (visible) {
        ...
        return (react_1.default.createElement(antd_1.Drawer, __assign({}, drawer, { visible: visible }),
            react_1.default.createElement(react_2.FormProvider, { form: env.form },
            ...
            env.promise = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, (0, __builtins__1.loading)(drawer.loadingText, function () {
                        ...
                        case 1:
                            ...
                            env.form =
                                env.form ||
                                    (0, core_1.createForm)(__assign(__assign({}, props), { effects: function (form) {
                                            var _a;
...
var DrawerExtra = function (props) {
    ...
    var _a = __read((0, react_1.useState)(), 2), extra = _a[0], setExtra = _a[1];
    var extraRef = (0, react_1.useRef)();
    ...
    return (react_1.default.createElement("div", { ref: ref, style: { display: 'none' } }, extra && (0, react_dom_1.createPortal)(props.children, extra)));
};
