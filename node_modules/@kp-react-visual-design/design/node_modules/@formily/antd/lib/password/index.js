...
exports.Password = (0, react_2.connect)(function (props) {
    ...
    return (react_1.default.createElement("span", { className: className },
        react_1.default.createElement(antd_1.Input.Password, __assign({}, others, { value: value })),
        checkStrength && (react_1.default.createElement(PasswordStrength_1.PasswordStrength, { value: String(value) }, function (score) {
