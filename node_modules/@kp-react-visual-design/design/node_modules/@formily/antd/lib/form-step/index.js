...
exports.FormStep = (0, react_2.connect)((0, react_2.observer)(function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, classnames_1.default)(prefixCls, className) },
        react_1.default.createElement(antd_1.Steps, __assign({}, props, { style: __assign({ marginBottom: 10 }, props.style), current: current }), steps.map(function (_a, key) {
            var props = _a.props;
            return react_1.default.createElement(antd_1.Steps.Step, __assign({}, props, { key: key }));
        })),
        steps.map(function (_a, key) {
            var name = _a.name, schema = _a.schema;
            if (key !== current)
                return;
            return react_1.default.createElement(react_2.RecursionField, { key: key, name: name, schema: schema });
        })));
}));
