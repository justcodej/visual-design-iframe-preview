(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ArrayBase = function (props) {
        ...
        return (React.createElement(Formily.React.RecordsScope, { getRecords: function () { return field.value; } },
    ...
    ArrayBase.Item = function (_a) {
        ...
        return (React.createElement(ItemContext.Provider, { value: props },
            React.createElement(Formily.React.RecordScope, { getIndex: function () { return props.index; }, getRecord: function () { return takeRecord(props.record); } }, children)));
    };
    ...
    ArrayBase.Copy = React.forwardRef(function (props, ref) {
        ...
        if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
            return null;
        return (React.createElement(icons.CopyOutlined, __assign$2({}, props, { className: classnames("".concat(prefixCls, "-copy"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-copy-disabled") : '', props.className), ref: ref, onClick: function (e) {
    ...
    ArrayBase.Remove = React.forwardRef(function (props, ref) {
        ...
        if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
            return null;
        return (React.createElement(icons.DeleteOutlined, __assign$2({}, props, { className: classnames("".concat(prefixCls, "-remove"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-remove-disabled") : '', props.className), ref: ref, onClick: function (e) {
                var _a, _b, _c, _d;
                if (self === null || self === void 0 ? void 0 : self.disabled)
                    return;
                e.stopPropagation();
    ...
    ArrayBase.MoveDown = React.forwardRef(function (props, ref) {
        ...
        if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
            return null;
        return (React.createElement(icons.DownOutlined, __assign$2({}, props, { className: classnames("".concat(prefixCls, "-move-down"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-move-down-disabled") : '', props.className), ref: ref, onClick: function (e) {
                var _a, _b, _c, _d;
                if (self === null || self === void 0 ? void 0 : self.disabled)
                    return;
                e.stopPropagation();
    ...
    ArrayBase.MoveUp = React.forwardRef(function (props, ref) {
        ...
        if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
            return null;
        return (React.createElement(icons.UpOutlined, __assign$2({}, props, { className: classnames("".concat(prefixCls, "-move-up"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-move-up-disabled") : '', props.className), ref: ref, onClick: function (e) {
                var _a, _b, _c;
                if (self === null || self === void 0 ? void 0 : self.disabled)
                    return;
                e.stopPropagation();
    ...
    var useArrayTableColumns = function (field, sources) {
        return sources.reduce(function (buf, _a, key) {
            ...
            return buf.concat(__assign$2(__assign$2({}, columnProps), { key: key, dataIndex: name, render: function (value, record) {
                    var _a;
                    var index = (_a = field === null || field === void 0 ? void 0 : field.value) === null || _a === void 0 ? void 0 : _a.indexOf(record);
    ...
    var useColumns = function () {
        ...
        validSchema === null || validSchema === void 0 ? void 0 : validSchema.mapProperties(function (schema, name) {
            if (isColumnComponent(schema)) {
                var props = schema === null || schema === void 0 ? void 0 : schema['x-component-props'];
                columns.push(__assign$2(__assign$2({}, props), { title: (props === null || props === void 0 ? void 0 : props.title) || (schema === null || schema === void 0 ? void 0 : schema.title), dataIndex: (props === null || props === void 0 ? void 0 : props.dataIndex) || name }));
            }
        });
        return columns;
    };
