...
var getObservableMaker = function (target) {
    if (target[environment_1.MakeObservableSymbol]) {
        if (!target[environment_1.MakeObservableSymbol][environment_1.MakeObservableSymbol]) {
            return target[environment_1.MakeObservableSymbol];
        }
        return (0, exports.getObservableMaker)(target[environment_1.MakeObservableSymbol]);
    }
};
