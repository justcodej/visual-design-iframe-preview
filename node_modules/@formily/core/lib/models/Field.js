...
var Field = /** @class */ (function (_super) {
    ...
    Field.prototype.initialize = function () {
        ...
        this.value = (0, internals_1.getValidFieldDefaultValue)(this.props.value, this.props.initialValue);
    ...
    Object.defineProperty(Field.prototype, "value", {
        ...
        set: function (value) {
            ...
            if (!this.initialized) {
                ...
                if (!(0, internals_1.allowAssignDefaultValue)(this.value, value) && !this.designable) {
                    return;
                }
            }
    ...
    Object.defineProperty(Field.prototype, "initialValue", {
        ...
        set: function (initialValue) {
            if (this.destroyed)
                return;
            if (!this.initialized) {
                if (!(0, internals_1.allowAssignDefaultValue)(this.initialValue, initialValue) &&
                    !this.designable) {
                    return;
                }
            }
