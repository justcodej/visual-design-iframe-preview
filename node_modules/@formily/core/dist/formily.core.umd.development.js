(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var destroy = function (target, address, removeValue) {
        if (removeValue === void 0) { removeValue = true; }
                    ...
                    case 0:
                        ...
                        if (!Formily.Shared.isUndef(target.value)) {
                            if (options === null || options === void 0 ? void 0 : options.forceClear) {
                                ...
                                target.value = Formily.Reactive.toJS(!Formily.Shared.isUndef(target.initialValue)
                                    ? target.initialValue
                                    : typedDefaultValue);
                            }
                        }
    ...
    var Field = /** @class */ (function (_super) {
        ...
        Field.prototype.makeReactive = function () {
            ...
            this.disposers.push(createReaction(function () { return _this.value; }, function (value) {
                ...
                if (Formily.Shared.isValid(value) && _this.selfModified && !_this.caches.inputting) {
                    validateSelf(_this);
                }
        ...
        function Form(props) {
            ...
            this.setInitialValues = function (initialValues, strategy) {
                ...
                if (!Formily.Shared.isPlainObj(initialValues))
                    return;
                if (strategy === 'merge' || strategy === 'deepMerge') {
                    _this.initialValues = Formily.Shared.merge(_this.initialValues, initialValues, {
                        arrayMerge: function (target, source) { return source; },
                    });
                }
                else if (strategy === 'shallowMerge') {
